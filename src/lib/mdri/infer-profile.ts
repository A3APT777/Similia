...
// Формат: строка = фраза для includes(), /regex/ = для точного матчинга
const ACUTE_MARKERS = [
  'внезапн', 'резко', 'вчера', 'сегодня', 'час назад',
  'травм', 'удар', 'падени', 'ожог', 'укус',
  'температур', 'лихорадк', 'озноб',
  'отравлени',
  'приступ', 'криз', 'колик',
...
const CHRONIC_MARKERS = [
  'давно', 'годами', 'год назад', 'года назад', 'лет назад',
  'хронич', 'постоянн', 'рецидив',
  'с детства', 'всегда', 'периодическ', 'регулярн',
  'конституц', 'миазм', 'наследствен', 'семейный анамнез', 'анамнез',
  'chronic', 'years ago', 'months ago', 'recurrent',
]
