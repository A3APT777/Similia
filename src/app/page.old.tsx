  ...
  return (
    <div className="relative w-full max-w-[540px] mx-auto select-none pointer-events-none lp-mockup" aria-hidden="true">
      <div className="rounded-2xl overflow-hidden" style={{ border: '1px solid rgba(45,106,79,0.18)', backgroundColor: '#f0ebe3', boxShadow: '0 32px 64px rgba(26,48,32,0.22)' }}>
        ...
        {/* Шапка */}
        <div className="flex items-center justify-between px-4 py-2.5" style={{ backgroundColor: 'white', borderBottom: '1px solid rgba(0,0,0,0.06)' }}>
        ...
        <div className="px-4 py-2.5 flex items-center justify-between" style={{ backgroundColor: '#faf7f2', borderBottom: '1px solid rgba(0,0,0,0.06)' }}>
          <div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 140px' }}>
          ...
          {/* Левая панель */}
          <div style={{ padding: '12px', display: 'flex', flexDirection: 'column', gap: '10px', borderRight: '1px solid rgba(0,0,0,0.06)', backgroundColor: '#f8f7f4' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
              <div>
                ...
                <div style={{ borderRadius: '8px', padding: '6px 10px', fontSize: '11px', backgroundColor: 'white', border: '1px solid rgba(0,0,0,0.04)', lineHeight: 1.5, color: '#3a2e1a' }}>яркий свет, шум</div>
              </div>
              <div>
                <div style={{ fontSize: '9px', fontWeight: 700, textTransform: 'uppercase', color: '#16a34a', opacity: 0.8, marginBottom: '4px' }}>Лучше от</div>
                <div style={{ borderRadius: '8px', padding: '6px 10px', fontSize: '11px', backgroundColor: 'white', border: '1px solid rgba(0,0,0,0.04)', lineHeight: 1.5, color: '#3a2e1a' }}>темнота, сон</div>
              </div>
            </div>

            <div>
              <div style={{ fontSize: '9px', fontWeight: 700, textTransform: 'uppercase', color: '#7a6e64', marginBottom: '4px' }}>Психика</div>
              <div style={{ borderRadius: '8px', padding: '6px 10px', fontSize: '11px', backgroundColor: 'white', border: '1px solid rgba(0,0,0,0.04)', lineHeight: 1.5, color: '#3a2e1a' }}>раздражительность накануне приступа</div>
            </div>
          ...
          <div style={{ padding: '12px', display: 'flex', flexDirection: 'column', gap: '10px', backgroundColor: 'white' }}>
            ...
            <div style={{ paddingTop: '6px', borderTop: '1px solid rgba(0,0,0,0.06)' }}>
        ...
        {/* Футер */}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '8px 16px', backgroundColor: '#f8f7f4', borderTop: '1px solid rgba(0,0,0,0.06)' }}>
  ...
  return (
    <div className="select-none pointer-events-none mx-auto" style={{ maxWidth: '360px' }}>
      <div className="rounded-2xl overflow-hidden" style={{ border: '1px solid rgba(45,106,79,0.18)', backgroundColor: '#f0ebe3', boxShadow: '0 16px 40px rgba(26,48,32,0.18)' }}>
        ...
        {/* Шапка */}
        <div className="flex items-center justify-between px-3 py-2" style={{ backgroundColor: 'white', borderBottom: '1px solid rgba(0,0,0,0.06)' }}>
        ...
        <div className="p-3 space-y-2.5" style={{ backgroundColor: '#f8f7f4' }}>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <div style={{ borderRadius: '7px', padding: '5px 9px', fontSize: '11px', backgroundColor: 'white', border: '1px solid rgba(0,0,0,0.04)', color: '#3a2e1a' }}>яркий свет, шум</div>
            </div>
            <div>
              <div style={{ fontSize: '8px', fontWeight: 700, textTransform: 'uppercase', color: '#16a34a', opacity: 0.8, marginBottom: '3px' }}>Лучше от</div>
              <div style={{ borderRadius: '7px', padding: '5px 9px', fontSize: '11px', backgroundColor: 'white', border: '1px solid rgba(0,0,0,0.04)', color: '#3a2e1a' }}>темнота, сон</div>
            </div>
          </div>
          ...
          {/* Мини-динамика */}
          <div style={{ borderRadius: '9px', padding: '8px 12px', backgroundColor: 'white', border: '1px solid rgba(0,0,0,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        {/* Футер */}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '7px 12px', backgroundColor: '#f8f7f4', borderTop: '1px solid rgba(0,0,0,0.06)' }}>
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--color-parchment)' }}>
      ...
      <style>{`
        ...
        .lp-feat-card:hover { border-color: var(--sim-border) !important; box-shadow: 0 4px 16px rgba(0,0,0,0.08); transform: translateY(-2px); }
      ...
      <header className="sticky top-0 z-40 border-b" style={{ backgroundColor: 'rgba(247,243,237,0.92)', backdropFilter: 'blur(12px)', borderColor: 'rgba(0,0,0,0.06)' }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          ...
          <nav aria-label="Основная навигация" className="flex items-center gap-3">
            ...
            <Link href="/register" className="lp-btn lp-btn-green text-sm font-semibold text-white px-4 py-2 rounded-2xl" style={{ backgroundColor: 'var(--sim-green)' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <div className="lp-hero-cta flex flex-wrap items-center gap-3 mb-5">
                <Link href="/register" className="lp-btn lp-btn-green inline-flex items-center gap-2 text-white font-semibold px-6 py-3.5 rounded-2xl text-sm" style={{ backgroundColor: 'var(--sim-green)', boxShadow: '0 4px 24px rgba(45,106,79,0.3)' }}>
                  Начать бесплатно
                  <ArrowRight />
                </Link>
                <Link href="/login" className="lp-btn lp-btn-outline inline-flex items-center gap-2 font-medium px-6 py-3.5 rounded-2xl text-sm border bg-white" style={{ color: '#4b5563', borderColor: '#e5e7eb' }}>
                  Уже есть аккаунт
                </Link>
              </div>
      ...
      <section className="py-16 sm:py-20 border-b" style={{ borderColor: 'rgba(0,0,0,0.06)' }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-10 text-center">
            ...
            <Link href="/register" className="lp-btn lp-btn-green inline-flex items-center gap-2 text-white font-semibold px-6 py-3 rounded-2xl text-sm" style={{ backgroundColor: 'var(--sim-green)', boxShadow: '0 4px 20px rgba(45,106,79,0.25)' }}>
      ...
      <section className="py-16 sm:py-20 border-t" style={{ borderColor: 'rgba(0,0,0,0.06)' }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {FEATURES.map((f, i) => (
              <div key={i} className="lp-feat-card bg-white rounded-2xl p-6 border border-gray-100">
                <div className="w-10 h-10 rounded-2xl flex items-center justify-center mb-4" style={{ backgroundColor: 'rgba(45,106,79,0.08)', color: 'var(--sim-green)' }}>{f.icon}</div>
          ...
          <div className="mt-10 text-center">
            <Link href="/register" className="lp-btn lp-btn-green inline-flex items-center gap-2 text-white font-semibold px-7 py-3.5 rounded-2xl text-sm" style={{ backgroundColor: 'var(--sim-green)', boxShadow: '0 4px 20px rgba(45,106,79,0.25)' }}>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="rounded-2xl p-6 border-2" style={{ backgroundColor: 'rgba(45,106,79,0.04)', borderColor: 'rgba(45,106,79,0.3)' }}>
              ...
              <Link href="/register" className="lp-btn lp-btn-green w-full inline-flex items-center justify-center gap-2 text-white font-semibold px-5 py-3 rounded-2xl text-sm" style={{ backgroundColor: 'var(--sim-green)' }}>
            ...
            <div className="rounded-2xl p-6 border bg-white" style={{ borderColor: '#2d6a4f' }}>
              ...
              <Link href="/pricing" className="lp-btn lp-btn-green w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-2xl text-sm font-semibold text-white" style={{ backgroundColor: 'var(--sim-green)' }}>Подробнее о тарифах <ArrowRight /></Link>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="relative overflow-hidden rounded-3xl px-8 sm:px-14 py-12 sm:py-16 text-center" style={{ backgroundColor: 'var(--sim-forest)' }}>
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap items-center justify-center gap-3">
                <Link href="/register" className="lp-btn lp-btn-gold inline-flex items-center gap-2 font-semibold px-8 py-3.5 rounded-2xl text-sm" style={{ backgroundColor: 'var(--sim-amber)', color: 'var(--sim-forest)' }}>
                  Создать аккаунт <ArrowRight />
                </Link>
                <Link href="/login" className="lp-btn lp-btn-outline text-sm font-medium px-6 py-3.5 rounded-2xl border" style={{ borderColor: 'rgba(255,255,255,0.3)', color: 'rgba(255,255,255,0.85)' }}>Войти</Link>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div>
              ...
              <p className="text-sm text-gray-600">Цифровой кабинет гомеопата · Данные в РФ</p>
              <p className="text-sm text-gray-600 mt-1">© 2026 Similia</p>
            </div>
