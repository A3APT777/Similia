...
// ─── Шаги первичной анкеты (хронический случай) ───────────────────────────────

const PRIMARY_STEPS: Step[] = [
  {
    title: 'Жалобы',
    subtitle: 'Расскажите подробно, что вас беспокоит',
    fields: [
      {
        key: 'chief_complaint',
        label: 'Подробное описание всех жалоб. Что именно сегодня беспокоит больше всего? Сопутствующие симптомы.',
        type: 'textarea',
        placeholder: 'Опишите все жалобы подробно, начиная с главной...',
        required: true,
      },
      {
        key: 'duration',
        label: 'Когда начались первые жалобы? Сколько времени беспокоит? Последовательность возникновения. С чем связываете?',
        type: 'textarea',
        placeholder: 'С какого момента считаете себя «нездоровым», после каких событий?',
      },
      {
        key: 'time_worse',
        label: 'Когда и в какое время случаются ухудшения? (время по часам, сезон, периодичность)',
        type: 'textarea',
        placeholder: 'Например: хуже с 3 до 5 утра, осенью обостряется, раз в месяц...',
      },
    ],
  },
  {
    title: 'Характер и эмоции',
    subtitle: 'Расскажите о себе как о человеке',
    fields: [
      {
        key: 'character',
        label: 'Расскажите о своём характере, темпераменте, эмоциональных реакциях на разные раздражители.',
        type: 'textarea',
        placeholder: 'Какой вы человек? Как реагируете на стресс, конфликты, обиды?',
      },
      {
        key: 'fears',
        label: 'Есть ли у вас страхи или тревоги? О чём они?',
        type: 'textarea',
        placeholder: 'Темноты, одиночества, болезни, смерти, высоты, будущего... Любые, даже «нелогичные»',
      },
      {
        key: 'consolation',
        label: 'Когда вам плохо — как вы реагируете на утешение?',
        type: 'chips',
        options: ['Становится легче', 'Нейтрально', 'Раздражает, хочется побыть одному'],
      },
      {
        key: 'company',
        label: 'Когда вам плохо — вы предпочитаете?',
        type: 'chips',
        options: ['Быть рядом с людьми', 'Нейтрально', 'Побыть в тишине и одиночестве'],
      },
      {
        key: 'weeping',
        label: 'Слёзы — как у вас с этим?',
        type: 'chips',
        options: ['Плачу легко, часто', 'Плачу, но только наедине', 'Редко, с трудом', 'Почти никогда'],
      },
    ],
  },
  {
    title: 'Сон',
    subtitle: 'Поведение и особенности сна',
    fields: [
      {
        key: 'sleep',
        label: 'Как вы спите? Легко засыпаете? Просыпаетесь ночью? В какое время?',
        type: 'textarea',
        placeholder: 'Любимая поза, качество сна, трудности с засыпанием...',
      },
      {
        key: 'sleep_behavior',
        label: 'Поведение во сне',
        type: 'chips-multi',
        options: ['Разговариваю', 'Смеюсь', 'Вскрикиваю', 'Скрежещу зубами', 'Сплю на животе', 'На спине', 'На боку', 'Ничего из перечисленного'],
      },
      {
        key: 'dreams',
        label: 'Есть ли характерные или повторяющиеся сны?',
        type: 'text',
        placeholder: 'Если есть — опишите коротко',
      },
    ],
  },
  {
    title: 'Термика и чувствительность',
    subtitle: 'Как вы реагируете на температуру и среду',
    fields: [
      {
        key: 'thermal',
        label: 'Вы жаркий или зябкий?',
        type: 'chips',
        options: ['Жаркий', 'Зябкий', 'Всегда зябкий', 'Нейтрально', 'По-разному'],
      },
      {
        key: 'heat_cold',
        label: 'Как переносите жару или холод?',
        type: 'textarea',
        placeholder: 'Что хуже переносите? Как реагируете на перепады температуры?',
      },
      {
        key: 'sea',
        label: 'Как чувствуете себя на море?',
        type: 'chips',
        options: ['Хорошо, помогает', 'Без разницы', 'Плохо, хуже становится', 'Не знаю'],
      },
      {
        key: 'allergies',
        label: 'Нет ли аллергий, кожных заболеваний или проявлений?',
        type: 'textarea',
        placeholder: 'На что аллергия? Есть ли сыпь, экзема, крапивница?',
      },
    ],
  },
  {
    title: 'Питание и жажда',
    subtitle: 'Пищевые пристрастия — важный симптом',
    fields: [
      {
        key: 'food_desires',
        label: 'Ваши пищевые пристрастия, даже если это «вредно»?',
        type: 'textarea',
        placeholder: 'Что любите? К чему тянет? Солёное, сладкое, кислое, жирное, острое...',
      },
      {
        key: 'food_aversions',
        label: 'Что не переносите?',
        type: 'text',
        placeholder: 'Жирное, молоко, яйца, мясо...',
      },
      {
        key: 'thirst',
        label: 'Жажда',
      ...
      },
      {
        ...
        type: 'chips',
        options: ['Только холодное', 'Прохладное', 'Комнатной температуры', 'Тёплое', 'Горячее'],
      },
    ],
  },
  {
    title: 'Потоотделение и энергия',
    subtitle: 'Детали работы организма',
    fields: [
      {
        key: 'perspiration',
        label: 'Потеете ли во сне или бодрствуя?',
        type: 'chips-multi',
        options: ['Во сне', 'При нагрузке', 'При волнении', 'Во время еды', 'Не потею', 'Сильно потею'],
      },
      {
        key: 'perspiration_where',
        label: 'Где потеете больше всего? (необязательно)',
        type: 'text',
        placeholder: 'Голова, подмышки, ладони, стопы, всё тело...',
      },
      {
        key: 'energy',
  ...
  },
  {
    ...
    subtitle: 'История лечения и текущие препараты',
    fields: [
      {
        key: 'immunity',
        label: 'Как часто простужаетесь? Когда последний раз была высокая температура?',
        type: 'textarea',
        placeholder: 'Болеете ли ОРВИ? Как часто? Температура бывает или нет?',
      },
      {
        key: 'past_illnesses',
        label: 'Когда и чем лечились? От каких проблем удалось «избавиться» и каким способом?',
        type: 'textarea',
        placeholder: 'Антибиотики, гормоны, операции, гомеопатия... Как реагировали?',
      },
      {
        key: 'medications',
        label: 'Какие препараты принимаете сегодня?',
        type: 'text',
        placeholder: 'Если нет — оставьте пустым',
      },
      {
        key: 'surgeries',
        label: 'Были ли операции, травмы и когда?',
        type: 'textarea',
        placeholder: 'Переломы, удаление аппендикса, кесарево... Год и последствия',
      },
    ],
  },
  {
    title: 'Наследственность и прививки',
    subtitle: 'Семейная история и вакцинация',
    fields: [
      {
        key: 'family_history',
        label: 'Какие заболевания имеются в роду?',
        type: 'textarea',
        placeholder: 'У родителей, бабушек/дедушек: диабет, онкология, астма, туберкулёз, сердечные...',
      },
      {
        key: 'vaccines',
        label: 'Делали ли прививки? Какие, когда и как реагировали?',
        type: 'textarea',
        placeholder: 'Были ли реакции на прививки? Ухудшение здоровья после вакцинации?',
      },
    ],
  },
  {
    title: 'Беременность и роды',
    subtitle: 'Если знаете — расскажите. Если нет — пропустите.',
    fields: [
      {
        key: 'mother_pregnancy',
        label: 'Чем болела мама во время беременности? Лечилась ли? Какие особенности протекания?',
        type: 'textarea',
        placeholder: 'Токсикоз, инфекции, стресс, приём лекарств... Если не знаете — оставьте пустым',
      },
      {
        key: 'birth_process',
        label: 'Как прошёл родовой процесс?',
        type: 'textarea',
        placeholder: 'Естественные роды, кесарево, стимуляция, осложнения... Если не знаете — оставьте пустым',
      },
    ],
  },
  {
    ...
    fields: [
      {
        ...
        type: 'textarea',
        placeholder: 'Вздутие, изжога, тяжесть после еды, тошнота...',
      },
      {
        key: 'stool',
        label: 'Стул',
        type: 'chips',
        options: ['Регулярный', 'Склонность к запорам', 'Склонность к послаблению', 'Чередуется'],
      },
      {
        key: 'menstrual',
        label: 'Для женщин: менструальный цикл (необязательно)',
        type: 'textarea',
        placeholder: 'Регулярность, болезненность, обильность, изменения самочувствия до/после/во время...',
      },
      {
        key: 'skin',
...
function BookingSection({ token, schedule, doctorId }: { token: string; schedule: ScheduleConfig; doctorId: string }) {
    ...
    return (
      <div className="mt-6 rounded-xl border border-[rgba(45,106,79,0.15)] bg-[rgba(45,106,79,0.04)] p-5 text-center">
        <div className="w-10 h-10 rounded-full bg-[rgba(45,106,79,0.08)] flex items-center justify-center mx-auto mb-3">
          <svg className="w-5 h-5 text-(--sim-green)" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
          </svg>
        </div>
        <p className="text-sm font-semibold text-(--sim-green)">Вы записаны!</p>
        <p className="text-sm text-(--sim-green) mt-1">{bookedDate}</p>
      </div>
    )
  }
  ...
  return (
    <div className="mt-6 rounded-xl border border-gray-200 bg-white p-5">
      <p className="text-sm font-semibold text-(--sim-text) mb-1">Записаться на первичную консультацию</p>
      <p className="text-xs text-(--sim-text-muted) mb-4">Необязательно — можно пропустить и договориться отдельно</p>

      <p className="text-xs font-semibold text-(--sim-text-muted) uppercase tracking-wide mb-2">Выберите дату</p>
          ...
          <button
            ...
            className={`shrink-0 px-3 py-2 rounded-xl border text-xs font-medium transition-all ${
              selectedDate === d
                ...
                : 'border-gray-200 text-gray-600 hover:border-gray-300 bg-(--sim-bg)'
            }`}
          >
            {formatDateRu(d)}
          </button>
      ...
      {bookingState === 'loading' && (
        <p className="text-xs text-(--sim-text-muted) text-center py-3">Загружаю доступные слоты...</p>
      )}

      {bookingState === 'ready' && slots.length === 0 && (
        <p className="text-xs text-(--sim-text-muted) text-center py-3">На эту дату нет свободных мест</p>
      )}

      {bookingState === 'ready' && slots.length > 0 && (
        <>
          <p className="text-xs font-semibold text-(--sim-text-muted) uppercase tracking-wide mb-2">Выберите время</p>
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 bg-[#2d6a4f] hover:bg-(--sim-forest) disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-semibold py-3 rounded-xl transition-colors"
        >
          {bookingState === 'booking' ? 'Записываю...' : 'Записаться'}
        </button>
        <button
          onClick={() => setSkipped(true)}
          className="px-4 py-3 text-sm text-(--sim-text-muted) hover:text-gray-600 transition-colors"
        >
          Пропустить
        </button>
      </div>
...
export default function IntakeForm({ token, patientName, type: initialType, prefilled, schedule, doctorId, doctorPatientId, initialAnswers, customFields }: Props) {
  ...
  const [selectedType, setSelectedType] = useState<IntakeType | null>(initialType)
  ...
  const btnClass = isAcute
    ...
    : 'bg-(--sim-green) hover:bg-(--sim-forest) text-white'

  const chipActiveClass = isAcute
    ? 'bg-[rgba(234,88,12,0.08)] text-[#ea580c] border-[rgba(234,88,12,0.2)]'
    : 'bg-[rgba(45,106,79,0.08)] text-(--sim-green) border-[rgba(45,106,79,0.2)]'

  const progressClass = isAcute ? 'bg-[#ea580c]' : 'bg-(--sim-green)'
  const focusRingClass = isAcute
    ? 'focus:border-[rgba(234,88,12,0.4)] focus:ring-orange-500/10'
    : 'focus:border-(--sim-green) focus:ring-[#2d6a4f]/30/10'
        ...
        <div className="w-full max-w-sm">
          <div className="text-center mb-6">
            <div className="w-16 h-16 rounded-xl bg-[rgba(45,106,79,0.08)] flex items-center justify-center mx-auto mb-5">
              <svg className="w-8 h-8 text-(--sim-green)" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
              </svg>
            </div>
            ...
            <p className="text-(--sim-text-muted) text-sm leading-relaxed">
      ...
      <div className="min-h-screen flex items-center justify-center px-4 py-8 ">
        <div className="max-w-sm w-full">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              <h1 className="text-xl font-medium text-(--sim-text) leading-tight">
                {patientName ? `${patientName.split(' ')[0]}, здравствуйте!` : 'Здравствуйте!'}
              </h1>
              <p className="text-xs text-(--sim-text-muted) mt-0.5">Выберите тип обращения</p>
            </div>
          </div>

          <p className="text-sm text-(--sim-text-muted) leading-relaxed mb-5">
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="font-medium text-(--sim-text)">Острый случай</span>
              </div>
              <p className="text-xs text-(--sim-text-muted) leading-relaxed">
            ...
            <button
              ...
              className="w-full text-left p-4 rounded-xl border-2 border-[rgba(45,106,79,0.15)] bg-[rgba(45,106,79,0.03)] hover:border-(--sim-green) transition-all"
            >
              <div className="flex items-center gap-2 mb-1">
                <span className="text-lg">📋</span>
                <span className="font-medium text-(--sim-text)">Хронический случай</span>
              </div>
              <p className="text-xs text-(--sim-text-muted) leading-relaxed">
        ...
        <div className="max-w-sm w-full">
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              ...
              <p className="text-xs text-(--sim-text-muted) mt-0.5">{cfg.welcomeTitle}</p>
            </div>
          </div>

          <p className="text-sm text-(--sim-text-muted) leading-relaxed mb-4">{cfg.welcomeText}</p>

          {prefilled && (
            <div className="mb-3 flex items-center gap-2 rounded-xl px-3 py-2.5 text-xs border bg-[rgba(45,106,79,0.04)] border-[rgba(45,106,79,0.15)] text-(--sim-green)">
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <div key={i} className="flex items-center gap-2">
                  ...
                  <p className="text-xs text-(--sim-text-muted)">{item.text}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {!isDoctorMode && (
            <label className="flex items-start gap-2.5 cursor-pointer mb-4">
              ...
              />
              <span className="text-[12px] text-(--sim-text-muted) leading-relaxed">
                Согласен(а) на обработку персональных данных, включая трансграничную передачу (ст. 12 ФЗ-152), в соответствии с <a href="/privacy" target="_blank" className="text-(--sim-green) underline">политикой конфиденциальности</a>. Данные используются только для оказания медицинской помощи и не передаются третьим лицам.
              </span>
            </label>
          )}

          {draftRestored && (
            <div className={`mb-3 flex items-center gap-2 rounded-xl px-3 py-2.5 text-xs border ${isAcute ? 'bg-orange-50 border-[rgba(234,88,12,0.15)] text-orange-700' : 'bg-[rgba(45,106,79,0.04)] border-[rgba(45,106,79,0.15)] text-(--sim-green)'}`}>
              <svg className="w-3.5 h-3.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          {draftRestored && (
            <button
              ...
              className="w-full text-xs text-(--sim-text-muted) hover:text-gray-600 mt-2 transition-colors"
            >
              Начать заново
            </button>
          )}
    ...
    <div className="min-h-screen overflow-x-hidden" style={{ backgroundColor: "var(--sim-bg)" }}>
      <div className="sticky top-0 z-10 bg-white border-b border-gray-100">
        ...
        <div className="px-4 py-2 flex items-center justify-between">
          <button
            onClick={handleBack}
            className="text-sm text-(--sim-text-muted) hover:text-gray-700 flex items-center gap-1 transition-colors"
          >
          ...
          <span className="text-xs text-(--sim-text-muted) font-medium">Шаг {step + 1} из {totalSteps}: {currentStep.title}</span>
        </div>
      </div>

      <div className="max-w-lg mx-auto px-4 py-4 pb-24">
        <div className="mb-4">
          <h2 className="text-lg font-medium text-(--sim-text)">{currentStep.title}</h2>
          {currentStep.subtitle && (
            <p className="text-xs text-(--sim-text-muted) mt-0.5 leading-relaxed">{currentStep.subtitle}</p>
          )}
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 overflow-hidden shadow-sm">
          {currentStep.fields.map((field, fieldIdx) => (
            ...
            >
              ...
              {field.hint && (
                <p className="text-[12px] text-(--sim-text-muted) mb-2 leading-relaxed">{field.hint}</p>
              )}
                    ...
                    <button
                      ...
                      className={`text-xs px-3 py-1.5 rounded-lg border font-medium transition-all ${
                        answers[field.key] === opt
                          ? chipActiveClass
                          : 'border-gray-200 text-(--sim-text-muted) hover:border-gray-300 bg-(--sim-bg)'
                      }`}
                    >
                      {opt}
                    </button>
                      ...
                      <button
                        ...
                        className={`h-9 rounded-lg border text-xs font-semibold transition-all ${
                          answers[field.key] === String(n)
                            ...
                            : 'border-gray-200 text-(--sim-text-muted) bg-(--sim-bg)'
                        }`}
                      >
                        {n}
                      </button>
