...
// ─── Памятка-анкета перед первичной консультацией (17 пунктов) ────────────────

const MEMO_STEPS: Step[] = [
  {
    title: 'Жалобы и история',
    subtitle: 'Расскажите подробно о том, что вас беспокоит',
    fields: [
      {
        key: 'memo_complaints',
        label: '1. Подробное описание всех жалоб. Что именно сегодня беспокоит больше всего? Сопутствующие симптомы.',
        type: 'textarea',
      ...
      {
        key: 'memo_timeline',
        label: '2. Когда начались первые жалобы? Сколько времени беспокоит каждый симптом? Последовательность их возникновения. С чем связываете? С какого момента считаете себя «нездоровым»?',
        type: 'textarea',
        placeholder: 'Например: головные боли начались 2 года назад после стресса на работе, потом добавилась бессонница...',
      },
      {
        key: 'memo_time_aggravation',
        label: '3. Когда и в какое время случаются ухудшения в самочувствии? (время по часам, сезон, периодичность)',
        type: 'textarea',
        placeholder: 'Например: хуже всего с 3 до 5 утра, осенью обостряется, раз в месяц...',
      },
    ],
  },
  {
    ...
    fields: [
      {
        key: 'memo_character',
        label: '4. Расскажите о себе — о своём характере, темпераменте, эмоциональных реакциях на разные раздражители.',
        type: 'textarea',
        placeholder: 'Какой вы человек? Как реагируете на стресс, конфликты, обиды?',
      },
      {
        key: 'memo_fears',
        label: '5. Есть ли у вас страхи или тревоги? О чём они?',
        type: 'textarea',
        placeholder: 'Страх темноты, высоты, одиночества, болезни, смерти... Любые, даже «нелогичные»',
      },
      {
        key: 'memo_sleep_behavior',
        label: '6. Поведение и поза во сне — разговор, смех во сне, не вскрикиваете ли, скрежет зубами?',
        type: 'textarea',
        placeholder: 'На каком боку спите, в какой позе, есть ли особенности...',
      },
    ],
  },
  {
    title: 'Термика и чувствительность',
    subtitle: 'Как вы реагируете на температуру и окружающую среду',
    fields: [
      {
        key: 'memo_thermal',
        label: '7. Вы жаркий или зябкий?',
        type: 'chips',
        options: ['Жаркий', 'Зябкий', 'Нейтрально', 'По-разному'],
      },
      {
        key: 'memo_heat_cold',
        label: '8. Как переносите жару или холод?',
        type: 'textarea',
        placeholder: 'Что хуже переносите? Как реагируете на перепады температуры?',
      },
      {
        key: 'memo_allergies',
        label: '9. Нет ли аллергий, кожных заболеваний или проявлений?',
        type: 'textarea',
        placeholder: 'На что аллергия? Есть ли сыпь, экзема, крапивница?',
      },
      {
        key: 'memo_sea',
        label: '10. Как чувствуете себя на море?',
        type: 'chips',
  ...
  },
  {
    ...
    subtitle: 'Пищевые привычки и история болезней',
    fields: [
      {
        key: 'memo_food',
        label: '11. Ваши пищевые пристрастия, даже если это «вредно»?',
        type: 'textarea',
        placeholder: 'Что любите есть? К чему тянет? Что не переносите? Солёное, сладкое, кислое, жирное...',
      },
      {
        key: 'memo_immunity',
        label: '12. Как часто простужаетесь? Когда последний раз была высокая температура?',
        type: 'textarea',
        placeholder: 'Болеете ли ОРВИ? Как часто? Температура бывает или нет?',
      },
      {
        key: 'memo_treatments',
        label: '13. Когда и чем лечились? От каких проблем удалось «избавиться» и каким способом? Какие препараты принимаете сегодня?',
        type: 'textarea',
        placeholder: 'Антибиотики, гормоны, операции, гомеопатия... Как реагировали?',
      },
      {
        key: 'memo_surgeries',
        label: '14. Были ли операции, травмы и когда?',
        type: 'textarea',
  ...
  },
  {
    ...
    fields: [
      {
        key: 'memo_perspiration',
        label: '15. Потеете ли во сне или бодрствуя?',
        type: 'chips-multi',
        options: ['Во сне', 'При нагрузке', 'При волнении', 'Не потею', 'Сильно потею', 'Нормально'],
      },
      {
        key: 'memo_heredity',
        label: '16. Какие заболевания имеются в роду?',
        type: 'textarea',
        placeholder: 'У родителей, бабушек/дедушек: диабет, онкология, астма, туберкулёз, сердечные...',
      },
      {
        key: 'memo_vaccines',
        label: '17. Делали ли прививки? Какие, когда и как реагировали?',
        type: 'textarea',
...
const CONFIG = {
  ...
  memo: {
    steps: [PERSONAL_STEP, ...MEMO_STEPS],
    welcomeTitle: 'Памятка по подготовке к консультации',
    welcomeText: 'Врач просит вас заполнить памятку перед первой консультацией. Ваши ответы помогут провести приём максимально эффективно — уделите 20–30 минут.',
    icon: '📝',
  },
}
