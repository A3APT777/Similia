...
export const metadata: Metadata = {
  ...
  description: "Ведите пациентов, ищите рубрики в реперториуме и отслеживайте динамику — всё в одном месте. Данные хранятся в России.",
  ...
  openGraph: {
    ...
    description: "Карточки пациентов, реперторий (74 000+ рубрик), анкеты до приёма и опросы самочувствия. Для практикующих гомеопатов.",
