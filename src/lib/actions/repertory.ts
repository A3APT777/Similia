...
const RU_TO_EN: Record<string, string[]> = {
  // Клинические темы — связанные рубрики как в Synthesis
  'обман': ['deceit', 'deceiv', 'cheat', 'fraud', 'betray', 'forsaken', 'reject'],
  'предательств': ['betray', 'deceit', 'forsaken', 'reject', 'friendless'],
  'покинут': ['forsaken', 'abandoned', 'reject', 'friendless', 'alone'],
  'отверж': ['reject', 'forsaken', 'friendless', 'contempt'],
  'бред': ['delusion', 'delirium'],
  'галлюцинац': ['hallucination', 'delusion', 'vision', 'phantom'],
  'ревнов': ['jealous', 'envy', 'suspicious'],
  'подозрит': ['suspicious', 'distrust', 'jealous', 'paranoi'],
  'раздраж': ['irritab', 'vexation', 'anger', 'cross'],
  'гнев': ['anger', 'rage', 'fury', 'irritab', 'violent'],
  'злос': ['malicious', 'anger', 'cruelty', 'destructive'],
  'печал': ['sadness', 'grief', 'sorrow', 'melanchol', 'weeping'],
  'тоск': ['sadness', 'grief', 'anguish', 'despair', 'melanchol'],
  'горе': ['grief', 'sorrow', 'ailments from', 'sadness'],
  'отчаян': ['despair', 'hopeless', 'suicid'],
  'безнадежн': ['hopeless', 'despair', 'suicid'],
  'равнодуш': ['indifferen', 'apathy'],
  'апат': ['apathy', 'indifferen', 'prostrat'],
  'забывч': ['forgetful', 'memory', 'absent-minded'],
  'рассеян': ['absent-minded', 'concentrat', 'forgetful'],
  'плакс': ['weeping', 'crying', 'tearful', 'sobbing'],
  'плач': ['weeping', 'crying', 'sobbing', 'tearful'],
  'смех': ['laughing', 'mirth'],
  'одиноч': ['alone', 'forsaken', 'solitude', 'company'],
  'нетерп': ['impatien', 'hurry', 'haste'],
  'торопл': ['hurry', 'haste', 'impatien'],
  'болтлив': ['loquacity', 'talking', 'chattering'],
  'молчал': ['taciturn', 'silent', 'reserved'],
  'застенч': ['timid', 'bashful', 'shy', 'cowardice'],
  'стыд': ['shame', 'mortification', 'humiliation'],
  'вин': ['guilt', 'reproach', 'conscience'],
  'самоубийств': ['suicide', 'kill herself', 'death', 'despair'],
  'убийств': ['kill', 'murder', 'homicid', 'destructive'],
  'воровств': ['steal', 'kleptomania', 'theft'],
  'религиозн': ['religious', 'conscience', 'scrupulous'],
  'проклят': ['cursing', 'swearing', 'blasphemy'],
  // Клинические темы — ailments from
  'испуг': ['fright', 'fear', 'shock', 'ailments from'],
  'унижен': ['mortification', 'humiliation', 'shame', 'ailments from'],
  'оскорблен': ['indignation', 'mortification', 'anger', 'ailments from'],
  'разочарован': ['disappointment', 'ailments from', 'grief'],
  'домашн': ['homesickness', 'nostalgia'],
  'тоска по дому': ['homesickness'],
  'навязчив': ['obsessive', 'persistent', 'fixed'],
  'маниакальн': ['mania', 'manic', 'delirium'],
  'истерик': ['hysteri', 'hysterical'],
  'эпилепс': ['epilep', 'convulsion'],
  'сомнамбул': ['somnambul', 'sleepwalk'],
  'клаустрофоб': ['claustrophobia', 'narrow', 'closed'],
  'агорафоб': ['agoraphobia', 'open', 'crowd'],
