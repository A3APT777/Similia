...
const CASES: TestCase[] = [
  ...
  // 15. Gelsemium
  {
    ...
    symptoms: [
      { rubric: 'anticipation exam', category: 'mental', present: true, weight: 3 },
      { rubric: 'drowsiness heaviness', category: 'general', present: true, weight: 3 },
      { rubric: 'eyelids heaviness', category: 'general', present: true, weight: 3 },
      { rubric: 'weakness trembling', category: 'general', present: true, weight: 2 },
      { rubric: 'thirstless', category: 'general', present: true, weight: 2 },
    ],
    modalities: [], familyHistory: [],
  ...
  // 31. Medorrhinum
  {
    ...
    symptoms: [
      { rubric: 'eczema', category: 'particular', present: true, weight: 2 },
      { rubric: 'worse night', category: 'general', present: true, weight: 2 },
      { rubric: 'sleep position abdomen', category: 'general', present: true, weight: 3 },
      { rubric: 'better seashore', category: 'general', present: true, weight: 3 },
      { rubric: 'desire sweets', category: 'general', present: true, weight: 1 },
      { rubric: 'worse morning', category: 'general', present: true, weight: 2 },
    ],
  ...
  // 32. Tuberculinum
  {
    ...
    symptoms: [
      { rubric: 'desire travel', category: 'mental', present: true, weight: 3 },
      ...
      { rubric: 'desire cold milk', category: 'general', present: true, weight: 2 },
      { rubric: 'perspiration night', category: 'general', present: true, weight: 2 },
      { rubric: 'glands enlarged', category: 'particular', present: true, weight: 2 },
      { rubric: 'ringworm', category: 'particular', present: true, weight: 2 },
    ],
  ...
  // 45. Mag phos
  {
    ...
    symptoms: [
      { rubric: 'cramps spasms', category: 'particular', present: true, weight: 3 },
      { rubric: 'better warmth hot applications', category: 'general', present: true, weight: 3 },
      ...
      { rubric: 'right side worse', category: 'general', present: true, weight: 3 },
      { rubric: 'pain shooting lightning', category: 'particular', present: true, weight: 2 },
    ],
    modalities: [], familyHistory: [],
    profile: { ...DEFAULT_PROFILE, age: 'child' },
  },
