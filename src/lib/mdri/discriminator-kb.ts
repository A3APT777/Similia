...
export const DISCRIMINATOR_KB: DifferentialPairKB[] = [
  ...
  // ═══ 3. Natrum mur vs Sepia ═══
  {
    ...
    discriminators: [
      {
        id: 'NATM_SEP_FAMILY_REACTION', type: 'behavior',
        labelRu: 'Когда близкие (муж, дети) просят внимания или заботы — какая первая реакция?',
        labelInternal: 'guilt withdrawal vs indifference irritation',
        clinicalMeaning: 'Nat-m хочет помочь но не может — замыкается, винит себя. Sep — раздражение, безразличие, нет сил и желания.',
        whyItMatters: 'Вина vs отсутствие эмоций. Разные эмоции, не пересекаются.',
        evidenceLevel: 'high', falsePositiveRisk: 'low',
        options: [
          { id: 'a', labelRu: 'Хочу помочь, но не могу — закрываюсь, ухожу в себя, потом виню себя',
            effect: 'supports_a', confidenceWeight: 1.0,
            mappedSymptoms: [
              { canonicalKey: 'GRIEF_SUPPRESSED_GUILT', rubric: 'grief suppressed old silent', weight: 3, category: 'mental' },
            ] },
          { id: 'b', labelRu: 'Раздражает, хочется чтобы оставили в покое — нет сил и желания',
            effect: 'supports_b', confidenceWeight: 1.0,
            mappedSymptoms: [
              { canonicalKey: 'INDIFFERENCE_FAMILY', rubric: 'indifference family husband children', weight: 3, category: 'mental' },
            ] },
          { id: 'none', labelRu: 'Не могу сказать / ситуация не подходит',
