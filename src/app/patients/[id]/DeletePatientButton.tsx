      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm" onClick={() => setShowModal(false)}>
          <div
            ...
            className="relative rounded-xl p-6 w-[340px] mx-4 shadow-2xl"
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-base font-semibold" style={{ color: 'var(--sim-text)' }}>{t(lang).deletePatient.confirm}</h2>
