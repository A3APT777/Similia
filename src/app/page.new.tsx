      ...
      <section className="min-h-[100vh] flex flex-col justify-center relative pt-16">
        <div className="max-w-[1200px] mx-auto px-6 w-full">
          <div className="max-w-[720px]">
            ...
            <div className="lr-reveal lr-reveal-3 flex items-center gap-4 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              ...
              },
              {
                ...
                desc: 'Жалобы, назначения, динамика — вся история в одном месте. Откройте карточку и сразу видьте полную картину.',
                accent: '∞',
              },
              {
                title: 'Анкета до приёма',
                desc: 'Отправьте ссылку — пациент заполнит дома. На приёме вы уже знаете жалобы, модальности, психику.',
                accent: '−20 мин',
              },
              {
                title: 'Опрос самочувствия',
                desc: 'Ссылка после приёма. Пациент отвечает за 2 минуты. Вы видите: лучше, хуже, новые симптомы.',
                accent: 'Follow-up',
              },
            ].map((f, i) => (
              <div key={i} className="lr-feature">
                <div className="lr-serif text-[36px] font-light mb-6" style={{ color: 'var(--lr-green)', letterSpacing: '-0.02em' }}>
                  {f.accent}
                </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="hidden lg:flex justify-center">
              <div className="text-[120px] font-light lr-serif" style={{ color: 'rgba(255,255,255,0.05)', letterSpacing: '-0.05em' }}>
                MDRI
              </div>
            </div>
          </div>
        ...
        <div className="max-w-[800px] mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-left max-w-[600px] mx-auto">
            <div className="lr-feature">
              ...
              <Link href="/register" className="block mt-6 text-center text-[14px] font-medium py-3 rounded-full transition-colors" style={{ border: '1px solid var(--lr-border)', color: 'var(--lr-fg)' }}>
                Начать
              </Link>
            </div>
