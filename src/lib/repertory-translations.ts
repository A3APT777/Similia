...
const T: Record<string, string> = {
  ...
  // ── ЧАСТОТНЫЕ НЕПЕРЕВЕДЁННЫЕ СЛОВА ────────────────────────────────
  // Топ-50 английских слов, встречающихся в fullpath_ru без перевода
  'exhalation': 'выдох',
  'otherwise': 'иначе',
  'step': 'шаг',
  'uneasiness': 'беспокойство',
  'alcoholics': 'алкоголики',
  'downwards': 'вниз',
  'putting': 'положив',
  'changing': 'меняя',
  'vanishing': 'исчезающий',
  'disordered': 'расстроенный',
  'increasing': 'усиливающийся',
  'cut': 'порез',
  'overheated': 'перегревшись',
  'lies': 'ложь',
  'balls': 'шары',
  'carried': 'когда несут',
  'nurses': 'кормилицы',
  'casts': 'отливки',
  'reverberating': 'отдающийся эхом',
  'boiled': 'варёный',
  'echoes': 'эхо',
  'cars': 'повозки',
  'protruded': 'выступающий',
  'thrilling': 'трепещущий',
  'nostril': 'ноздря',
  'blackness': 'чернота',
  'overlifting': 'от перенапряжения',
  'flames': 'пламя',
  'pull': 'тянуть',
  ...
  'hear': 'слышать',
  'fevers': 'лихорадки',
  'screwing': 'ввинчивающий',
  'drumming': 'барабанящий',
  'fro': 'и обратно',
  'see': 'видеть',
  'smiling': 'улыбаясь',
  'yellowness': 'желтизна',
  ...
  'coming': 'приходящий',
  'becomes': 'становится',
  'becomes worse': 'ухудшается',
  'keeps': 'держит',
  'makes': 'делает',
  'feels': 'чувствует',
  'feels as if': 'чувствует как будто',
  'seems': 'кажется',
  'looks': 'выглядит',
  'looking': 'глядя',
  'watching': 'наблюдая',
  ...
  'eating': 'при еде',
  'swallowing': 'при глотании',
  'sneezing': 'при чихании',
  'yawning': 'при зевоте',
  'straining': 'при натуживании',
  'lifting': 'при подъёме',
  'reaching': 'при потягивании',
  'stepping': 'при шаге',
}
